...
class BaseNode(models.Model):
    ...
    description = models.TextField(null=True)
    in_degree = models.ManyToManyField("self", symmetrical=False, related_name="income_degree", null=True, blank=True)
    out_degree = models.ManyToManyField("self", symmetrical=False, related_name="outcome_degree", null=True, blank=True)
